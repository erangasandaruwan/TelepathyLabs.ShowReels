...
import { TimeCode, VideoClipTimeCodes } from '../../models/time-code';
import { ShowReel } from '../../models/show-reel';
import { Router } from '@angular/router';

@Component({
  selector: 'show-reel-editor',
  templateUrl: './show-reel-editor.component.html',
  styleUrls: ['./show-reel-editor.component.css'],
  encapsulation: ViewEncapsulation.None,
  styles: ['#outer-show-reel { border-radius: 3px; border: 1px gray; margin: 0 10 0 10; }']
})
export class ShowReelEditorComponent implements OnInit {
  ...
  constructor(
    ...
    private showReelervice: ShowReelService,
